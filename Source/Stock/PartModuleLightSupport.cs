...
namespace CrewLight.Support.Stock
{
	public class Light : CrewLight.Support.Interface
	{
		public Light () { }

		private static string[] moduleNames = new string[] { "ModuleLight", "ModuleStockLightColoredLens", "ModuleMultiPointSurfaceLight", "ModuleColoredLensLight" };
