...
*/
using TargetModule = global::ModuleKELights.ModuleKELight;

namespace CrewLight.Support.KerbalElectric
{
	public class KerbalElectric : CrewLight.Support.Interface
	{
		public KerbalElectric () { }

		private static string[] moduleNames = new string[]{ "ModuleKELight" };
